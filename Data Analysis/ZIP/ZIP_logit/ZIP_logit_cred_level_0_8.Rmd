---
title: "Bayesian Credible Subgroups( ZIP logit model) log(time) as a offset"
...
hist(y, xlab = 'Number of new tumors', cex.main = 2,  cex.lab = 1.4, main = 'Histogram of number of new tumors')
...
PoisJag = function(Model,data, nIter){
 ...
 X = cbind(1,trt=covariate$treat,initnr=covariate$initnr,
  ...
  ###JAGS for zipmodel1
  jagsmodel1 <- jags.model(textConnection(zipModelkm_logit),data=datalist1,quiet=TRUE)
